	    ...
	    If Alltrim(qLGRUPO -> ZT4_TIPO) != "T" .and. Alltrim(qLGRUPO -> ZT4_TIPO) != ""
				    ...
				    While (!qTGRUPO->(Eof()))
                           ...
                           if Alltrim(qLGRUPO -> ZT4_TIPO) == "E" 				 	   
							...
							oPrint:Say(nLinha,0850, Transform((((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB)  )+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV)  )+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP)  ))*MV_PAR05, "@E 999,999,999,999"), oFont07)
							//MOIVMENTOS CONTABEIS PWB
							oPrint:Say(nLinha,1250, Transform(((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB)  )*MV_PAR05, "@E 999,999,999,999"), oFont07)
							//MOVIMENTOS CONTABEIS PWP
							oPrint:Say(nLinha,1650, Transform(((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP)  )*MV_PAR05, "@E 999,999,999,999"), oFont07)
							//MOVIMENTOS CONTABEIS PMV
							oPrint:Say(nLinha,2050, Transform(((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV)  )*MV_PAR05, "@E 999,999,999,999"), oFont07)
...
Static Function xCabec()
	...
	oPrint:Say(250,1690, "PW Para", oFont07)
	...
	oPrint:Say(250,2090, "Monte Verde", oFont07)
