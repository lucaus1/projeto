	    ...
	    If Alltrim(qLGRUPO -> ZT4_TIPO) != "T" .and. Alltrim(qLGRUPO -> ZT4_TIPO) != ""
				    ...
				    While (!qTGRUPO->(Eof()))
                           ...
                           if Alltrim(qLGRUPO -> ZT4_TIPO) == "E" 				 	   
							...
							oPrint:Say(nLinha,0850, Transform((((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)  ))*MV_PAR05, "@E 999,999,999,999"), oFont07)
							//MOIVMENTOS CONTABEIS BKE
							oPrint:Say(nLinha,1250, Transform(((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)  )*MV_PAR05, "@E 999,999,999,999"), oFont07)
...
Static Function xCabec()
	...
	oPrint:Say(250,1300, "BK Energy", oFont07)
