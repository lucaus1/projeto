	...
	While (!qLGRUPO->(Eof()))
	    ...
	    If Alltrim(qLGRUPO -> ZT4_TIPO) != "T" .and. Alltrim(qLGRUPO -> ZT4_TIPO) != ""
				    ...
				    While (!qTGRUPO->(Eof()))
							...
							_cValZero := ((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV) + qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP) + qTGRUPO->SAPWP)
							if _cValZero < 0.1 .and. mv_par07 == 2
								qTGRUPO->(dbSkip())
								loop
							Endif
						...
						//IFRS
							oPrint:Say(nLinha,0760, Transform(((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV) + qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP) + qTGRUPO->SAPWP), "@E 999,999,999"), oFont07)
							oPrint:Say(nLinha,0960, PadR(Transform((((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV) + qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP) + qTGRUPO->SAPWP))/_Cambio, "@E 999,999,999"), 14), oFont07)

						//AJUSTES 
							oPrint:Say(nLinha,1160, Transform((qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV), "@E 999,999,999"), oFont07)
							oPrint:Say(nLinha,1360, Transform(((qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV))/_Cambio, "@E 999,999,999"), oFont07)
						//CONSOLIDADO LOCAL
							oPrint:Say(nLinha,1560, Transform(((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+ qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP) + qTGRUPO->SAPWP), "@E 999,999,999"), oFont07)
							oPrint:Say(nLinha,1760, Transform((((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+ qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP) + qTGRUPO->SAPWP))/_Cambio, "@E 999,999,999"), oFont07)
					    //MOIVMENTOS CONTABEIS PWB
							oPrint:Say(nLinha,1960, Transform((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+ qTGRUPO->SAPWB, "@E 999,999,999"), oFont07)
							oPrint:Say(nLinha,2160, Transform(((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+ qTGRUPO->SAPWB)/_Cambio, "@E 999,999,999"), oFont07)
						//MOVIMENTOS CONTABEIS PWPAMA	
							oPrint:Say(nLinha,2360, Transform((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP) + qTGRUPO->SAPWP, "@E 999,999,999"), oFont07)
							oPrint:Say(nLinha,2560, Transform(((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP) + qTGRUPO->SAPWP)/_Cambio, "@E 999,999,999"), oFont07)
						//MOVIMENTOS CONTABEIS PMV		
							oPrint:Say(nLinha,2760, Transform((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+ qTGRUPO->SAPMV, "@E 999,999,999"), oFont07)
							oPrint:Say(nLinha,2960, Transform(((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+ qTGRUPO->SAPMV)/_Cambio, "@E 999,999,999"), oFont07)
							nLinha += 40
                    
                           if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
	   							_SUConRs += ((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV) + qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP) + qTGRUPO->SAPWP)
								_SUConUs += (((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV) + qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP) + qTGRUPO->SAPWP))/_Cambio
								_SUAjuRs += (qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV)
							    _SUAjuUs += ((qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV))/_Cambio
								_SUEliRs += ((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+ qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP) + qTGRUPO->SAPWP)
							    _SUEliUs += (((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+ qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP) + qTGRUPO->SAPWP))/_Cambio
								_SUPWBRs += (qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+ qTGRUPO->SAPWB
							    _SUPWBUs += ((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+ qTGRUPO->SAPWB)/_Cambio
							   	_SUPWPRs += (qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+ qTGRUPO->SAPWP
							    _SUPWPUs += (qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+ qTGRUPO->SAPWP/_Cambio
							   	_SUPMVRs += (qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV) + qTGRUPO->SAPMV
					  		    _SUPMVUs += ((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV) + qTGRUPO->SAPMV)/_Cambio
	                       endif
                    ...
                    if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
						...
						//SUBTOTAL PWB
						oPrint:Say(nLinha,1960, Transform(_SUPWBRs, "@E 999,999,999"), oFont07)
						oPrint:Say(nLinha,2160, Transform(_SUPWBUs, "@E 999,999,999"), oFont07)
						//SUBTOTAL PWPAMA
						oPrint:Say(nLinha,2360, Transform(_SUPWPRs, "@E 999,999,999"), oFont07)
						oPrint:Say(nLinha,2560, Transform(_SUPWPUs, "@E 999,999,999"), oFont07)
						//SUBTOTAL PMV
						oPrint:Say(nLinha,2760, Transform(_SUPMVRs, "@E 999,999,999"), oFont07)
						oPrint:Say(nLinha,2960, Transform(_SUPMVUs, "@E 999,999,999"), oFont07)
						nLinha += 40
						oPrint:Line(nLinha,050,nLinha,3180)
	   				    nLinha += 20
	    ...
	    Elseif Alltrim(qLGRUPO -> ZT4_TIPO) =='T'
				    ...
				    While (!qTGRUPO->(Eof()))
						    ...
						    _Cambio := 0	
   							...
   							_TOConRs += ((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV) + qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP) + qTGRUPO->SAPWP)
							_TOConUs += (((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV) + qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP) + qTGRUPO->SAPWP))/_Cambio
							_TOAjuRs += (qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV)
						    _TOAjuUs += ((qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV))/_Cambio
							_TOEliRs += ((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+ qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP) + qTGRUPO->SAPWP)
						    _TOEliUs += (((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB) + qTGRUPO->SAPWB)+((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+ qTGRUPO->SAPMV)+((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP) + qTGRUPO->SAPWP))/_Cambio
							_TOPWBRs += (qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+ qTGRUPO->SAPWB
						    _TOPWBUs += ((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+ qTGRUPO->SAPWB)/_Cambio
						   	_TOPWPRs += (qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+ qTGRUPO->SAPWP
						    _TOPWPUs += (qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+ qTGRUPO->SAPWP/_Cambio
						   	_TOPMVRs += (qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV) + qTGRUPO->SAPMV
				  		    _TOPMVUs += ((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV) + qTGRUPO->SAPMV)/_Cambio
				    ...
				    End	
						...
						//SUBTOTAL PWB
						oPrint:Say(nLinha,1940, Transform(_TOPWBRs, "@E 999,999,999,999"), oFont07)
						oPrint:Say(nLinha,2140, Transform(_TOPWBUs, "@E 999,999,999,999"), oFont07)
						//SUBTOTAL PWP
						oPrint:Say(nLinha,2340, Transform(_TOPWPRs, "@E 999,999,999,999"), oFont07)
						oPrint:Say(nLinha,2540, Transform(_TOPWPUs, "@E 999,999,999,999"), oFont07)
						//SUBTOTAL PMV
						oPrint:Say(nLinha,2740, Transform(_TOPMVRs, "@E 999,999,999,999"), oFont07)
						oPrint:Say(nLinha,2940, Transform(_TOPMVUs, "@E 999,999,999,999"), oFont07)
						nLinha += 40
						oPrint:Line(nLinha,050,nLinha,3180)
	   				    nLinha += 20
				        _TOConRS := 0
