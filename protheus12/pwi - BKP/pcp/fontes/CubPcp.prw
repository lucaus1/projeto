...
nPe1 := M->D3_YPE1
nPe2 := M->D3_YPE2
nPonta1 := M->D3_YPONTA1
nPonta2 := M->D3_YPONTA2
nComp1  := M->D3_YCOMPRI
...
User Function CUBPCPL()
Private nVolL     := 0.00 //Variável de Retorno Volume Geométrico
Private aAlias    := GetArea()
Private nOcoPe    := 0.00
Private nOcoPonta := 0.00
Private nOcoMax   := 0.00   
Private nPe1,nPe2,nOcoPe1,nOcoPe2,nPonta1,nPonta2,nOcoPn1,nOcoPn2,nComp1,nComp2
