...
#DEFINE HMARGEM    035     // PADRAO 30 PARA 35
#DEFINE VMARGEM    035     // PARAO 30 PARA 35 em 30/01/2019
...
#DEFINE MAXVALORC  013 //padrao 009  - alterado em 01/10/2018                                                 // Máximo de caracteres por linha de valores numéricos
...
nForTo		:=	Len(cStrAux)/35 // de 25 pra 27  mil, potencial, franciney em 31/01/2019 
nForTo		+=	Iif(nForTo>Round(nForTo,0),Round(nForTo,0)+1-nForTo,nForTo)
For nX := 1 To nForTo
	oDanfe:Say(nLinCalc,098,SubStr(cStrAux,Iif(nX==1,1,((nX-1)*25)+1),30), oFont10N:oFont )  // 21/03/2019 - potencial 
	nLinCalc+=10
Next nX
...
If Type("oEmitente:_EnderEmit:_xCpl") <> "U"
	...
	// impressao da linha do telefone   - potencial 
    oDanfe:Say(nLinCalc,098,"Fone:  92 3521-3331/ 92 3521-3329", oFont08N:oFont ) 
Else
