...
cPesoB :=  oTransp:_vol:_pesol:TEXT
...
// Fim de analise de TAGs
	...
	aadd(aCabec,{"C5_PBRUTO" ,Val(oTransp:_vol:_pesol:TEXT) ,Nil,Nil})
	aadd(aCabec,{"C5_VOLUME1",Val(oTransp:_vol:_nvol:TEXT),Nil,Nil})
	...
	aadd(aCabec,{"C5_EMISSAO",dData,Nil,Nil})                   
	...
	DbSetOrder(1)
		...
		*/ 
        ...
        Do Case 
          Case SA1->A1_TIPO=="X"  // EXPORTACAO 
           aadd(aLinha,{"C6_TES",'701',Nil,Nil}) 
          Case SA1->A1_COD =="000884"   // AMAGGI
            aadd(aLinha,{"C6_TES",'552',Nil,Nil})  
          Case SA1->A1_COD =="000003"    // MOSS
            aadd(aLinha,{"C6_TES",'563',Nil,Nil})
          OTHERWISE   
            aadd(aLinha,{"C6_TES","501",Nil,Nil})   
        EndCase    
