	    ...
	    If Alltrim(qLGRUPO -> ZT4_TIPO) != "T" .and. Alltrim(qLGRUPO -> ZT4_TIPO) != ""
				    ...
				    While (!qTGRUPO->(Eof()))
                           ...
                           if Alltrim(qLGRUPO -> ZT4_TIPO) == "E" 				 	   
							...
							//BR GAAP
							oPrint:Say(nLinha,0790, Transform(((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE) )*MV_PAR06, "@E 999,999,999,999"), oFont07)

							//IFRS 
							oPrint:Say(nLinha,1060, Transform(((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)  )*MV_PAR06, "@E 999,999,999,999"), oFont07)
