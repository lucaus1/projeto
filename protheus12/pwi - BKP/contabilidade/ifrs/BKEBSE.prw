	...
	While (!qLGRUPO->(Eof()))
	    ...
	    If Alltrim(qLGRUPO -> ZT4_TIPO) != "T" .and. Alltrim(qLGRUPO -> ZT4_TIPO) != ""
				    ...
				    While (!qTGRUPO->(Eof()))
                           ...
                           if Alltrim(qLGRUPO -> ZT4_TIPO) == "E" 				 	   
							...
							oPrint:Say(nLinha,850, Transform((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)  , "@E 999,999,999,999"), oFont07)
							//MOIVMENTOS CONTABEIS BKE
							oPrint:Say(nLinha,1250, Transform((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)  , "@E 999,999,999,999"), oFont07)
				
							nLinha += 40
                                    

                           if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
                                _SUConRs += (qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)  
			                    _SUBKERs +=(qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)  
                    ...
                    if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
						...
						//SUBTOTAL BKE
						oPrint:Say(nLinha,1250, Transform(_SUBKERs, "@E 999,999,999,999"), oFont07)
	    ...
	    Elseif Alltrim(qLGRUPO -> ZT4_TIPO) =='T'
				    ...
				    While (!qTGRUPO->(Eof()))
		                    ...
		                    _TOConRs += (qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)  
		                    _TOBKERs +=((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)  )
					        qTGRUPO->(dbSkip())
				    ...
				    End	
						...
						//SUBTOTAL BKE
						oPrint:Say(nLinha,1250, Transform(_TOBKERs, "@E 999,999,999,999"), oFont07)
