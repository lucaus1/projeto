	    ...
	    If Alltrim(qLGRUPO -> ZT4_TIPO) != "T" .and. Alltrim(qLGRUPO -> ZT4_TIPO) != ""
				    ...
				    While (!qTGRUPO->(Eof()))
                           ...
                           if Alltrim(qLGRUPO -> ZT4_TIPO) == "E" 				 	   
							...
							//BR GAAP
							oPrint:Say(nLinha,0790, Transform((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+ qTGRUPO->SABKE, "@E 999,999,999,999"), oFont07)

							//IFRS 
							oPrint:Say(nLinha,1060, Transform(((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE), "@E 999,999,999,999"), oFont07)
                            
							//DIFERENÇA IFRS - BRGAAP
 							oPrint:Say(nLinha,1340, Transform(-(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE), "@E 999,999,999,999"), oFont07)
							
							nLinha += 40

                           if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
							 	    _SUConRS +=((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)
				                    _SUBKERs +=(qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE) + qTGRUPO->SABKE
 	 							    _SUEliRS +=(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)
	                       endif
                    ...
                    if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
						...
						oPrint:Say(nLinha,1340, Transform(-_SUEliRs, "@E 999,999,999,999"), oFont07)
	    ...
	    Elseif Alltrim(qLGRUPO -> ZT4_TIPO) =='T'
				    ...
				    While (!qTGRUPO->(Eof()))
                            ...
                            xVerPag()
					 	    	...
					 	    	_TOConRS +=((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)
 						 	    _TOAjuRs +=(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE)
   			                    _TOBKERs +=((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+ qTGRUPO->SABKE)
...
Static Function xCabec()
	...
	oPrint:Say(320,0860, "BRL", oFont07)
	...
	oPrint:Say(320,1130, "BRL", oFont07)
	...
	oPrint:Say(320,1410, "BRL", oFont07)
