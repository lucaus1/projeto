	    ...
	    If Alltrim(qLGRUPO -> ZT4_TIPO) != "T" .and. Alltrim(qLGRUPO -> ZT4_TIPO) != ""
				    ...
				    While (!qTGRUPO->(Eof()))
                           ...
                           if Alltrim(qLGRUPO -> ZT4_TIPO) == "E" 				 	   
							...
							oPrint:Say(nLinha,0760, Transform(((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)+(qTGRUPO->AJUSDEB - qTGRUPO->AJUSCRE)+(qTGRUPO->ELIDEB-qTGRUPO->ELICRE), "@E 999,999,999,999"), oFont07)
							oPrint:Say(nLinha,0960, Transform((((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)+(qTGRUPO->AJUSDEB - qTGRUPO->AJUSCRE)+(qTGRUPO->ELIDEB-qTGRUPO->ELICRE))/_Cambio, "@E 999,999,999,999"), oFont07)
							//AJUSTES
							...
							oPrint:Say(nLinha,1960, Transform((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE, "@E 999,999,999,999"), oFont07)
							oPrint:Say(nLinha,2160, Transform(((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)/_Cambio, "@E 999,999,999,999"), oFont07)				
							nLinha += 40
                    
                           if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
						 	    _SUConRS +=((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)+(qTGRUPO->AJUSDEB - qTGRUPO->AJUSCRE)+(qTGRUPO->ELIDEB-qTGRUPO->ELICRE)
						 	    _SUConUS +=(((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)+(qTGRUPO->AJUSDEB - qTGRUPO->AJUSCRE)+(qTGRUPO->ELIDEB-qTGRUPO->ELICRE))/_Cambio
			                    ...
			                    _SUBKERs +=(qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE
			                    _SUBKEUs +=((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)/_Cambio
	                       endif
                    ...
                    if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
						...
						//SUBTOTAL BKE
						oPrint:Say(nLinha,1960, Transform(_SUBKERs, "@E 999,999,999,999"), oFont07)
						oPrint:Say(nLinha,2160, Transform(_SUBKEUs, "@E 999,999,999,999"), oFont07)
						nLinha += 40
						oPrint:Line(nLinha,050,nLinha,2330)
	   				    nLinha += 20
	    ...
	    Elseif Alltrim(qLGRUPO -> ZT4_TIPO) =='T'
				    ...
				    While (!qTGRUPO->(Eof()))
						    ...
						    _Cambio := 0	
					 	    ...
					 	    _TOConRS +=((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)+(qTGRUPO->AJUSDEB - qTGRUPO->AJUSCRE)+(qTGRUPO->ELIDEB-qTGRUPO->ELICRE)
					 	    _TOConUS +=((((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)+(qTGRUPO->AJUSDEB - qTGRUPO->AJUSCRE)+(qTGRUPO->ELIDEB-qTGRUPO->ELICRE))/_Cambio)
		                    ...
		                    _TOBKERs +=((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)
		                    _TOBKEUs +=(((qTGRUPO->SLDDBKE - qTGRUPO->SLDCBKE)+(qTGRUPO->AJUDBKE - qTGRUPO->AJUCBKE) + qTGRUPO->SABKE)/_Cambio)		                    
					        qTGRUPO->(dbSkip())
				    ...
				    End	
						...
						//SUBTOTAL BKE
						oPrint:Say(nLinha,1960, Transform(_TOBKERs, "@E 999,999,999,999"), oFont07)
						oPrint:Say(nLinha,2160, Transform(_TOBKEUs, "@E 999,999,999,999"), oFont07)
						nLinha += 40
						oPrint:Line(nLinha,050,nLinha,2330)
	   				    nLinha += 20
				        _TOConRS := 0
...
Static Function xCabec()
	...
	oPrint:Say(050,050,AllTrim( "BK Energy" ),oFont08)
	...
	oPrint:Say(250,2050, "BK ENERGIA", oFont07)
