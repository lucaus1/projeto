	...
	While (!qLGRUPO->(Eof()))
	    ...
	    If Alltrim(qLGRUPO -> ZT4_TIPO) != "T" .and. Alltrim(qLGRUPO -> ZT4_TIPO) != ""
				    ...
				    While (!qTGRUPO->(Eof()))
                           ...
                           if Alltrim(qLGRUPO -> ZT4_TIPO) == "E" 				 	   
							...
							oPrint:Say(nLinha,850, Transform((qTGRUPO->SLDDPWA - qTGRUPO->SLDCPWA)+(qTGRUPO->AJUDPWA - qTGRUPO->AJUCPWA) + qTGRUPO->SAPWA+(qTGRUPO->SLDDMAD - qTGRUPO->SLDCMAD)+(qTGRUPO->AJUDMAD - qTGRUPO->AJUCMAD) + qTGRUPO->SAMAD+(qTGRUPO->SLDDCIL - qTGRUPO->SLDCCIL)+(qTGRUPO->AJUDCIL - qTGRUPO->AJUCCIL) + qTGRUPO->SACIL, "@E 999,999,999,999"), oFont07)
							//MOIVMENTOS CONTABEIS PWA
							oPrint:Say(nLinha,1250, Transform((qTGRUPO->SLDDPWA - qTGRUPO->SLDCPWA)+(qTGRUPO->AJUDPWA - qTGRUPO->AJUCPWA) + qTGRUPO->SAPWA, "@E 999,999,999,999"), oFont07)
							//MOVIMENTOS CONTABEIS MADAMA
							oPrint:Say(nLinha,1650, Transform((qTGRUPO->SLDDMAD - qTGRUPO->SLDCMAD)+(qTGRUPO->AJUDMAD - qTGRUPO->AJUCMAD) + qTGRUPO->SAMAD, "@E 999,999,999,999"), oFont07)
							//MOVIMENTOS CONTABEIS CIL
							oPrint:Say(nLinha,2050, Transform((qTGRUPO->SLDDCIL - qTGRUPO->SLDCCIL)+(qTGRUPO->AJUDCIL - qTGRUPO->AJUCCIL) + qTGRUPO->SACIL, "@E 999,999,999,999"), oFont07)
				
							nLinha += 40
                                    

                           if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
                                _SUConRs += (qTGRUPO->SLDDPWA - qTGRUPO->SLDCPWA)+(qTGRUPO->AJUDPWA - qTGRUPO->AJUCPWA) + qTGRUPO->SAPWA+(qTGRUPO->SLDDMAD - qTGRUPO->SLDCMAD)+(qTGRUPO->AJUDMAD - qTGRUPO->AJUCMAD) + qTGRUPO->SAMAD+(qTGRUPO->SLDDCIL - qTGRUPO->SLDCCIL)+(qTGRUPO->AJUDCIL - qTGRUPO->AJUCCIL) + qTGRUPO->SACIL
	    ...
	    Elseif Alltrim(qLGRUPO -> ZT4_TIPO) =='T'
				    ...
				    While (!qTGRUPO->(Eof()))
		                    ...
		                    _TOConRs += (qTGRUPO->SLDDPWA - qTGRUPO->SLDCPWA)+(qTGRUPO->AJUDPWA - qTGRUPO->AJUCPWA) + qTGRUPO->SAPWA+(qTGRUPO->SLDDMAD - qTGRUPO->SLDCMAD)+(qTGRUPO->AJUDMAD - qTGRUPO->AJUCMAD) + qTGRUPO->SAMAD+(qTGRUPO->SLDDCIL - qTGRUPO->SLDCCIL)+(qTGRUPO->AJUDCIL - qTGRUPO->AJUCCIL) + qTGRUPO->SACIL
