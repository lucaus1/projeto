...
    //  .--------------------------------.
    ...
    //  "--------------------------------"
  	...
  	aadd(aPerg,{cPerg, "05", "Empresa      ?","mv_ch5","N",1,0,1, "C","","mv_par05","ABN","","","","","","","","","","","","","",""})
	...
	While (!qLGRUPO->(Eof()))
	    ...
	    If Alltrim(qLGRUPO -> ZT4_TIPO) != "T" .and. Alltrim(qLGRUPO -> ZT4_TIPO) != ""
				    ...
				    While (!qTGRUPO->(Eof()))
                           ...
                           if Alltrim(qLGRUPO -> ZT4_TIPO) == "E" 				 	   
							...
							//BR GAAP
							oPrint:Say(nLinha,0790, Transform(((qTGRUPO->SLDDABN - qTGRUPO->SLDCABN) )*MV_PAR06, "@E 999,999,999,999"), oFont07)

							//IFRS 
							oPrint:Say(nLinha,1060, Transform(((qTGRUPO->SLDDABN - qTGRUPO->SLDCABN)+(qTGRUPO->AJUDABN - qTGRUPO->AJUCABN)  )*MV_PAR06, "@E 999,999,999,999"), oFont07)
                            
							//DIFERENÇA IFRS - BRGAAP
 							oPrint:Say(nLinha,1340, Transform(-(qTGRUPO->AJUDABN - qTGRUPO->AJUCABN)*MV_PAR06, "@E 999,999,999,999"), oFont07)
                    ...
                    if Alltrim(qLGRUPO -> ZT4_TIPO) != "E" 				 	   
						...
						//BR GAAP
						oPrint:Say(nLinha,0790, Transform(_SUABNRs, "@E 999,999,999,999"), oFont07)
	    ...
	    Elseif Alltrim(qLGRUPO -> ZT4_TIPO) =='T'
				    ...
				    While (!qTGRUPO->(Eof()))
                            ...
                            xVerPag()
					 	    	...
					 	    	_TOConRS +=((qTGRUPO->SLDDABN - qTGRUPO->SLDCABN)+(qTGRUPO->AJUDABN - qTGRUPO->AJUCABN)  )*MV_PAR06
 						 	    _TOAjuRs +=(qTGRUPO->AJUDABN - qTGRUPO->AJUCABN)*MV_PAR06
				    ...
				    End	
						...
						//SUBTOTAIS - BR GAAP
						oPrint:Say(nLinha,0790, Transform(_TOABNRs, "@E 999,999,999,999"), oFont07)
