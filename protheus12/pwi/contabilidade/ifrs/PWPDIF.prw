				...
				If MV_PAR05 == 1				    		   
				    ...
				    While (!qTGRUPO->(Eof()))
                           ...
                           if Alltrim(qLGRUPO -> ZT4_TIPO) == "E" 				 	   
							...
							//BR GAAP
 							If MV_par05 == 1
								oPrint:Say(nLinha,0790, Transform(((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB) )*MV_PAR06, "@E 999,999,999,999"), oFont07)
 							Elseif MV_par05 == 2
								oPrint:Say(nLinha,0790, Transform(((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP) )*MV_PAR06, "@E 999,999,999,999"), oFont07)
                            Elseif MV_par05 == 3
								oPrint:Say(nLinha,0790, Transform(((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV) )*MV_PAR06, "@E 999,999,999,999"), oFont07)
                            Endif

							//IFRS 
 							If MV_par05 == 1
								oPrint:Say(nLinha,1060, Transform(((qTGRUPO->SLDDPWB - qTGRUPO->SLDCPWB)+(qTGRUPO->AJUDPWB - qTGRUPO->AJUCPWB)  )*MV_PAR06, "@E 999,999,999,999"), oFont07)
							Elseif MV_par05 == 2
								oPrint:Say(nLinha,1060, Transform(((qTGRUPO->SLDDPWP - qTGRUPO->SLDCPWP)+(qTGRUPO->AJUDPWP - qTGRUPO->AJUCPWP)  )*MV_PAR06, "@E 999,999,999,999"), oFont07)
							Elseif MV_par05 == 3
								oPrint:Say(nLinha,1060, Transform(((qTGRUPO->SLDDPMV - qTGRUPO->SLDCPMV)+(qTGRUPO->AJUDPMV - qTGRUPO->AJUCPMV)  )*MV_PAR06, "@E 999,999,999,999"), oFont07)
							Endif
...
Static Function xCabec()
	...
	oPrint:Say(050,050, IIF(MV_PAR05==1,"Precious Woods Belem",IIF(MV_PAR05==2,"Precious Woods Para","Monte Verde" )),oFont08)
