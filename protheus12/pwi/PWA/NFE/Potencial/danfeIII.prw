...
If Type("oTransp:_Vol")<>"U"
	If ValType(oTransp:_Vol) == "A"
		...
		aTransp[12]	:= IIf(Type("oTransp:_Vol:_Esp")=="U",IIF((SM0->M0_CODIGO)=="01","Mad.Serr.","Diversos"),"")
				aTransp[13] := IIf(Type("oTransp:_Vol:_Marca")=="U",IIF((SM0->M0_CODIGO)=="01","MIL BRASIL",IIF((SM0->M0_CODIGO)=="03","BK ENERGIA","")),NoChar(oTransp:_Vol:_Marca:TEXT,lConverte))
	...
	Else
		...
		aTransp[12] := IIf(Type("oTransp:_Vol:_Esp")=="U",IIF((SM0->M0_CODIGO)=="01","Mad.Serr.","Diversos"),oTransp:_Vol:_Esp:TEXT)
		aTransp[13] := IIf(Type("oTransp:_Vol:_Marca")=="U",IIF((SM0->M0_CODIGO)=="01","MIL BRASIL",IIF((SM0->M0_CODIGO)=="03","BK ENERGIA","")),NoChar(oTransp:_Vol:_Marca:TEXT,lConverte))
		aTransp[14] := IIf(Type("oTransp:_Vol:_nVol:TEXT")<>"U",oTransp:_Vol:_nVol:TEXT,"")
...
oDanfe:Say(nLine+075,nBaseTxt, "NOTA FISCAL ELETRÔNICA",oFont10:oFont)
oDanfe:Say(nLine+085,nBaseTxt, "0-ENTRADA",oFont10:oFont)
oDanfe:Say(nLine+095,nBaseTxt, "1-SAÍDA"  ,oFont10:oFont)
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
If nfolha>=1
	oDanfe:SayBitmap(005,085,cLogo,080,090)
Endif
...
//	oDanfe:Box(nLine+454,nBaseCol,nLine+575,nBaseCol+30)
	...
	AADD(aColProd,{ 150,310 } )		// "DESCRIÇÃO DO PRODUTOS/SERVIÇOS"
	...
	oDanfe:Say(nLine+462,152,"DESCRIÇÃO DO PRODUTOS/SERVIÇOS",oFont08N:oFont)
